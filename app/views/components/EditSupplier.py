...
from app.views.templates.EditSupplier_ui import Ui_DialogEditSupplier
from app.views.components.Loading import Loading
from app.controllers.dedicated.edit import EditThread

class EditSupplier(Ui_DialogEditSupplier, QDialog):
    def __init__(self, authData, selectedData):
        ...
        self.lineEditSupplierName.setText(f"{self.selectedData['supplierName']}")
    ...
    def _onPushButtonSaveClicked(self):
        self.loading.show()
        self.currentThread = EditThread('editSupplierDataById', {
            'id': self.selectedData['id'],
            'supplierName': self.lineEditSupplierName.text().upper(),
        })
