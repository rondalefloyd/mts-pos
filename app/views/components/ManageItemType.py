...
class ManageItemTypes(Ui_FormManageItemType, QWidget):
    ...
    def _onPushButtonClearClicked(self):
        self.lineEditItemTypeName.setText("")
        pass
        
    def _onPushButtonAddClicked(self):
        self.loading.show()
        self.currentThread = RegisterThread('registerItemType', {'itemTypeName': self.lineEditItemTypeName.text().upper()})
    ...
    def _populateTableWidgetData(self):
        self.loading.show()
        self.currentThread = FetchThread('fetchAllItemTypeDataByKeywordInPagination', {
    ...
    def _onPushButtonDeleteClicked(self, data):
        confirm = QMessageBox.warning(self, 'Confirm', f"Delete {data['itemTypeName']}?", QMessageBox.StandardButton.Yes | QMessageBox.StandardButton.No)
        
        if confirm == QMessageBox.StandardButton.Yes:
            self.loading.show()
            self.currentThread = RemoveThread('removeItemTypeById', {'id': data['id']})
