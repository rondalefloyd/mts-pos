...
class EditItemType(Ui_DialogEditItemType, QDialog):
    def __init__(self, authData, selectedData):
        ...
        self.lineEditItemTypeName.setText(f"{self.selectedData['itemTypeName']}")
    ...
    def _onPushButtonSaveClicked(self):
        self.loading.show()
        self.currentThread = EditThread('editItemTypeDataById', {
            'id': self.selectedData['id'],
            'itemTypeName': self.lineEditItemTypeName.text().upper(),
        })
