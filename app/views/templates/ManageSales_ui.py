...
class Ui_FormManageSales(object):
    def setupUi(self, FormManageSales):
        ...
        self.frame = QtWidgets.QFrame(FormManageSales)
        ...
        self.labelOrderName = QtWidgets.QLabel(self.frame)
        ...
        self.comboBoxOrderType = QtWidgets.QComboBox(self.frame)
