...
class Ui_DialogEditStock(object):
    def setupUi(self, DialogEditStock):
        ...
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.lineEditOnHand)
        ...
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.lineEditAvailable)
