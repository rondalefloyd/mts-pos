...
# Form implementation generated from reading ui file 'c:\Users\mimoy\Documents\GitHub\mts-pos\app\views\templates\ManagePromo.ui'
#
...
class Ui_FormManageMember(object):
    ...
    def retranslateUi(self, FormManageMember):
        ...
        item.setText(_translate("FormManageMember", "PromoName"))
        item = self.tableWidgetData.horizontalHeaderItem(2)
        item.setText(_translate("FormManageMember", "DiscountRate"))
        ...
        self.label_3.setText(_translate("FormManageMember", "Promo name"))
        self.label_2.setText(_translate("FormManageMember", "Discount rate"))
