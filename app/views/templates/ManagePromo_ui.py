...
class Ui_FormManagePromo(object):
    def setupUi(self, FormManagePromo):
        ...
        self.scrollArea = QtWidgets.QScrollArea(FormManagePromo)
        ...
        self.pushButtonClear = QtWidgets.QPushButton(FormManagePromo)
        self.pushButtonClear.setObjectName("pushButtonClear")
        self.horizontalLayout_3.addWidget(self.pushButtonClear)
        self.pushButtonAdd = QtWidgets.QPushButton(FormManagePromo)
