...
class Ui_FormManageItem(object):
    ...
    def retranslateUi(self, FormManageItem):
        ...
        item.setText(_translate("FormManageItem", "ItemType"))
        item = self.tableWidgetData.horizontalHeaderItem(5)
        item.setText(_translate("FormManageItem", "Brand"))
        item = self.tableWidgetData.horizontalHeaderItem(6)
        item.setText(_translate("FormManageItem", "Supplier"))
        item = self.tableWidgetData.horizontalHeaderItem(7)
        item.setText(_translate("FormManageItem", "SalesGroup"))
        ...
        item.setText(_translate("FormManageItem", "HasPromo"))
        item = self.tableWidgetData.horizontalHeaderItem(12)
        item.setText(_translate("FormManageItem", "HasStock"))
