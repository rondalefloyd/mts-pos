...
class Ui_DialogInOrder(object):
    def setupUi(self, DialogInOrder):
        ...
        self.label_14 = QtWidgets.QLabel(self.frameRegister)
        ...
        self.labelHybridPayment = QtWidgets.QLabel(self.frameRegister)
        font = QtGui.QFont()
        font.setPointSize(13)
        self.labelHybridPayment.setFont(font)
        ...
        self.labelHybridShortageExcess = QtWidgets.QLabel(self.frameRegister)
        font = QtGui.QFont()
        font.setPointSize(13)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.label_13 = QtWidgets.QLabel(self.frameRegister)
        ...
        self.horizontalLayout.addWidget(self.frameRegister)
        ...
        self.pushButtonPayHybrid = QtWidgets.QPushButton(self.widgetConfirmationButton)
        self.pushButtonPayHybrid.setObjectName("pushButtonPayHybrid")
        self.horizontalLayout_4.addWidget(self.pushButtonPayHybrid)
