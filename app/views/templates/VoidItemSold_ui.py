...
class Ui_DialogVoidItemSold(object):
    def setupUi(self, DialogVoidItemSold):
        ...
        self.comboBoxReasonName.setEditable(True)
        self.comboBoxReasonName.setInsertPolicy(QtWidgets.QComboBox.NoInsert)
        self.comboBoxReasonName.setObjectName("comboBoxReasonName")
        self.comboBoxReasonName.addItem("")
        self.comboBoxReasonName.addItem("")
        self.comboBoxReasonName.addItem("")
        self.comboBoxReasonName.addItem("")
        self.comboBoxReasonName.addItem("")
    ...
    def retranslateUi(self, DialogVoidItemSold):
        ...
        self.comboBoxReasonName.setItemText(0, _translate("DialogVoidItemSold", "Customer Cancellation"))
        self.comboBoxReasonName.setItemText(1, _translate("DialogVoidItemSold", "Incorrect Entry"))
        self.comboBoxReasonName.setItemText(2, _translate("DialogVoidItemSold", "Price Discrepancy"))
        self.comboBoxReasonName.setItemText(3, _translate("DialogVoidItemSold", "Item Not Available"))
        self.comboBoxReasonName.setItemText(4, _translate("DialogVoidItemSold", "Payment Issue"))
