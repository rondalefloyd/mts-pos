...
# Form implementation generated from reading ui file 'c:\Users\mimoy\Documents\GitHub\mts-pos\app\ui\dialogs\edit_organization.ui'
#
...
class Ui_DialogEditOrganization(object):
    def setupUi(self, DialogEditOrganization):
        DialogEditOrganization.setObjectName("DialogEditOrganization")
        DialogEditOrganization.resize(400, 300)
        self.verticalLayout = QtWidgets.QVBoxLayout(DialogEditOrganization)
        self.verticalLayout.setObjectName("verticalLayout")
        self.label_6 = QtWidgets.QLabel(DialogEditOrganization)
        ...
        self.scrollArea = QtWidgets.QScrollArea(DialogEditOrganization)
        ...
        self.lineEditTaxId.setEnabled(True)
        ...
        QtCore.QMetaObject.connectSlotsByName(DialogEditOrganization)

    def retranslateUi(self, DialogEditOrganization):
        _translate = QtCore.QCoreApplication.translate
        DialogEditOrganization.setWindowTitle(_translate("DialogEditOrganization", "Edit"))
        self.label_6.setText(_translate("DialogEditOrganization", "MTS POS"))
        self.label.setText(_translate("DialogEditOrganization", "Organization Name"))
        self.label_2.setText(_translate("DialogEditOrganization", "Address"))
        self.label_3.setText(_translate("DialogEditOrganization", "Mobile number"))
